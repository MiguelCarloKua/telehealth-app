...
export default function DoctorConsultation({
  ...
  const handleStartConsultation = async () => {
    try {
      const updated = await apiCall(`/consultations/${appointmentId}`, {
        method: 'PATCH',
  ...
  return (
    <div className="h-screen flex flex-col bg-gray-50 dark:bg-gray-900">
      ...
      {/* Appointment Details + Control Buttons */}
      <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 p-4 md:p-6">
        ...
        consultationStarted ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-center py-12">
            ...
            <p className="text-gray-500 dark:text-gray-400 font-medium">
              Click &quot;Start Consultation&quot; to launch the video call.
            </p>
            <p className="text-sm text-gray-400 dark:text-gray-500 mt-1">
              The patient will join automatically once the session is live.
            </p>
          </div>
        )
      ) : (
